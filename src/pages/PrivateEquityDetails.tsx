...
import { PEAIInsights } from '@/components/accounts/PEAIInsights';
...
const PrivateEquityDetails = () => {
  ...
  const handleGenerateInsights = async () => {
    if (!id) return;
    navigate(`/private-equity/${id}/insights`, { state: { backUrl } });
  };
          ...
          <>
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
              <Tabs defaultValue="ai-insights" className="w-full">
                <TabsList className="grid grid-cols-3 w-full max-w-[620px] mx-auto mb-6">
                  ...
                  <TabsTrigger value="firm-details" className="tab-blue h-auto py-2.5 text-xs px-4 md:text-sm leading-tight flex items-center justify-center gap-2">
                    <Building2 className="w-4 h-4" /> Firm Details
                  </TabsTrigger>
                  <TabsTrigger value="documents" className="tab-amber h-auto py-2.5 text-xs px-4 md:text-sm leading-tight flex items-center justify-center gap-2">
                    <FileText className="w-4 h-4" /> Documents
                  </TabsTrigger>
                </TabsList>

                <TabsContent value="ai-insights" className="mt-0">
                  <PEAIInsights firmId={id} />
                </TabsContent>

                <TabsContent value="firm-details" className="space-y-8 mt-0">
                  {/* Overview Section */}
                ...
                <TabsContent value="documents" className="space-y-8 mt-0">
                  <AccountDocuments accountId={id} ownerType="pe" categoryMode="pe" />
                </TabsContent>
              </Tabs>
            </div>
          </>
