...
export const FinancialAccountCard: React.FC<FinancialAccountCardProps> = ({ account, onDelete, backUrl }) => {
  ...
  return (
    <Card
      ...
      onClick={() => navigate(`/financials/${account.id}`, { state: { backUrl } })}
    >
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={(e) => { e.stopPropagation(); navigate(`/financials/${account.id}/edit`); }}>
                Edit Account
              </DropdownMenuItem>
              {onDelete && (
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction className="bg-red-500 hover:bg-red-600" onClick={async (e) => { e.stopPropagation(); await onDelete(account.id); }}>Delete</AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
                </AlertDialog>
              )}
